...
tools = [
    ...
    Tool.from_function(
        ...
        description="Use this tool to search local knowledgebase and get information about electric power industry",
        args_schema=KnowledgeSearchInput,
    ),
    #need BING_SUBSCRIPTION_KEY
    # Tool.from_function(
